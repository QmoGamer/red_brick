<header>
	...
	<div id="booking" class="booking">
		<!-- <div class='booking_date input-group date' id='booking_check_in'>
			<div class="booking_date_text">入住日</div>
      <input type='text' placeholder="入住日" readonly />
      <span class="input-group-addon">
      	<img src="../public/images/btn_calendar_normal.svg" />
      </span>
	  </div>
		<div class='booking_date input-group date' id='booking_check_out'>
			<div class="booking_date_text">退房日</div>
      <input type='text' placeholder="退房日" readonly />
      <span class="input-group-addon">
      	<img src="../public/images/btn_calendar_normal.svg" />
      </span>
	  </div>
		<div class="booking_room_qty">
			<select>
				<option disabled selected>房間數量</option>
				<option>1</option>
				<option>2</option>
				<option>3</option>
			</select>
